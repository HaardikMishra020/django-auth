...
SECRET_KEY = "django-insecure--&%*3j5e)w4^4f_lbvi-!(7m3y+lry#vy1afp8b=8*a-(kan$)"
...
EMAIL_HOST_USER = os.getenv('SMTP_USER') #your email-id
EMAIL_HOST_PASSWORD = os.getenv('SMTP_PSWD') #your password
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
